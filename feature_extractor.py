...
def get_args():
    ...
    # io
    parser.add_argument('--dataset_path', default='D:\\Anomaly Detection',
    ...
    parser.add_argument('--pretrained_3d',
                        ...
                        default='D:\\Anomaly Detection\\pretrained\\c3d.pickle')

    return parser.parse_args()


def to_segments(data, num = 8):
    """
...
#python feature_extractor.py --dataset_path "D:\Anomaly Detection" --model_type "c3d" --pretrained_3d "D:\Anomaly Detection\pretrained\c3d.pickle"